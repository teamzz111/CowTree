                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="hidden-sm-down"> <span>
                                                <?php echo $elemento['Ejemplar']; $idee = $elemento['Ejemplar']; ?></span></td>
                                        <td class="hidden-sm-down"><span>
                                        ...
                                        <td>
                                                ...
                                                <button type="button" class="btn btn-warning" onclick="location.href= 'form-Tree.php?id=<?php echo $idee;?>'">Generar</button>
